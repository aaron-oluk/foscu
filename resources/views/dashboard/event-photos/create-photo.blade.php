...
@section('title', 'Add Photo to ' . $category->name)

@section('content')
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Add Photo to "{{ $category->name }}"</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('dashboard.event-photos.photos.store', $category->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
