        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold">Edit Partner Logo</h2>
                ...
                <form action="{{ route('admin.logos.update', $logo) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="partner_name" id="partner_name" value="{{ old('partner_name', $logo->partner_name) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="website_url" id="website_url" value="{{ old('website_url', $logo->website_url) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Leave empty to keep current logo. Recommended: PNG, JPG, or SVG format, max 2MB</p>
                        @error('image')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $logo->display_order) }}" 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                               min="0">
